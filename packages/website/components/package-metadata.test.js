...
describe('package metadata component', () => {
    ...
    it('should not render maintainers if maintainers does not exist', () => {
        const wrapper = mount(<PackageMetaData version="1.0.0" repository={{ url: 'git_url' }} />);
    ...
    it('should not render maintainers if maintainers exists but is empty', () => {
        const wrapper = mount(
            <PackageMetaData version="1.0.0" maintainers={[]} repository={{ url: 'git_url' }} />,
        );
    ...
    it('should handle repository field being a string', () => {
        const wrapper = mount(
            <PackageMetaData version="1.0.0" maintainers={['Peter Y']} repository="git_url" />,
        );
    ...
    it('should handle repository field being a string and convert git suffixes', () => {
        ...
        expect(wrapperSshRepo.find('a').prop('href')).toEqual('fake-repo-fix-later');
        expect(wrapperHttpsRepo.find('a').prop('href')).toEqual('fake-repo-fix-later');
    });

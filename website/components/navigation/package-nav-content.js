import { MenuSection, BackItem, Separator, Group } from '@atlaskit/navigation-next';
        ...
        <MenuSection id="package-section" parentId="index-section">
            {({ className }) => (
                <div className={className}>
                    <BackItem text="Back to packages" href="/packages" component={LinkComponent} />
                    <Separator />
...
const PackageNavContent = ({ packageId, packageName }) => {
    const packagePages = pageInfo.packages.find(pkg => pkg.packageId === packageId);
